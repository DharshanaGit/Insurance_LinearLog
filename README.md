...
- Logistic Regression is used for binary classification (0 or 1 outcome)
...
## 📌 Key Insight
Logistic Regression is more suitable for this dataset since the output is binary (0/1).
